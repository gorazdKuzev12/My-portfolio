...
const Projects = () => {
  ...
  return (
    <div className="w-full bg-gray-dark1 h-screen flex flex-col p-8 relative">
      ...
      <div className="text-center">
        <div className="relative">
          ...
          <h1 className="text-4xl text-gray-light font-bold font-custom tracking-wide">
            {"<projects/>"}
          </h1>
        </div>
        <div className="grid grid-cols-3 gap-4 mt-48 px-8">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center transition-opacity duration-500 ease-in-out bg-black bg-opacity-0 opacity-0 group-hover:opacity-100 group-hover:bg-opacity-70">
                <div className="text-center space-y-4">
                  <h2
                    className="text-white-original text-4xl font-bold uppercase group-hover:scale-110 transform transition-transform duration-500 tracking-widest"
                    style={{ textShadow: "1px 1px 2px rgba(0, 0, 0, 0.3)" }}
                  >
                    {title}
                  </h2>
                  <p
                    className="text-light-orange text-lg font-semibold group-hover:translate-y-2 transform transition-transform duration-500 tracking-widest"
