...
const ContactMe = () => {
  return (
    <div className="w-full h-screen flex justify-center  bg-gray-dark p-16 relative">
      ...
      <div className="text-center w-3/4">
        ...
        <div className="flex flex-row w-full justify-center text-center mt-40 space-x-10">
